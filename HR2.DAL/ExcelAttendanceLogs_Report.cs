...
namespace HR2.DAL
{
    ...
    public partial class ExcelAttendanceLogs_Report : HR2.EF.DAL.IEFEntity
    {
        public int ExcelAttendanceCustomizeReportId { get; set; }
        ...
        public Nullable<int> IsPrefixText { get; set; }
